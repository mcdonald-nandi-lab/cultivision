        ...
        <div className='p-6 sm:p-8'>
          ...
          <div className='prose max-w-none'>
            ...
            <p className='mb-6'>
              ...
              property of CultiVision and the Site&apos;s creators. This
            ...
            <p className='mb-6'>
              CultiVision and our directors, officers, agents, employees,
            ...
            <p className='mb-6'>
              ...
              and hold harmless CultiVision and our directors, officers, agents,
            ...
            <p className='mb-1'>snandi@ucdavis.edu</p>
